    // Kotitehtävä
    // Tee numeronarvauspeli, jossa salainen numero on 1-100
    // ja pelaaja yrittää arvata sen. 
    // anna pelaajalle vinkkejä: suumpi, pienempi, polttaa jne.
    // montako yritystä asia vaati?

    // Jos haluaa extroja niin, sitten voi arpoa kaksi lottoriviä
    // ja katsoa monta osumaa tulee... 
